        ...
        <div className="space-y-16">
          ...
          <article>
            ...
            <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6 max-w-2xl">
              從 MUI 遷移到 Shadcn/ui,以 wrapper pattern 重建 50 個元件,
              並建立完整的元件測試規範。
            </p>
          ...
          <article>
            ...
            <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6 max-w-2xl">
              拆分 webapp 與官網,將 webapp 從 Next.js 遷移到 Vite 7 + TanStack
              Router, 純 SPA 架構,啟動速度提升 21 倍。
            </p>
            <ul className="text-sm text-neutral-500 space-y-1">
          ...
          <article>
            ...
            <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6 max-w-2xl">
              用 LINE 訊息養成習慣的小工具。Rich menu 一鍵記錄,
          ...
          <article>
            ...
            <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6 max-w-2xl">
              整合 MCP Server、CLI 工具與 Skills Chatbot,
              讓內部團隊能用自然語言操作產品功能。
            </p>
            <ul className="text-sm text-neutral-500 space-y-1">
