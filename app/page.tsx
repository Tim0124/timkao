export default function Home() {
  return (
    <>
          ...
          <div className="space-y-16">
            ...
            <article>
              ...
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6 max-w-2xl">
                將 GoBuid 產品元件從 MUI 遷移到 Shadcn/ui,以 wrapper pattern
                重建 50 個元件,並建立完整的元件測試規範。
              </p>
            ...
            <article>
              ...
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6 max-w-2xl">
                主動發起的內部專案——觀察到 sales
                與行銷團隊在重複操作流程上的痛點, 自行打造 MCP Server、CLI
                工具與 Skills Chatbot,讓團隊能用自然語言操作產品功能。
              </p>
              <ul className="text-sm text-neutral-500 space-y-1">
        ...
        <section className="py-24 md:py-32 max-w-2xl">
          ...
          <div className="space-y-6 text-lg md:text-xl leading-relaxed text-neutral-700 dark:text-neutral-300">
            ...
            <p>
              ...
              擔任前端工程師, 平常做 design system、寫元件測試、優化 build
              time—— 從元件庫一路寫到產品架構決策。
            </p>
      ...
      {/* Footer */}
      <footer className="px-6 md:px-16 max-w-5xl mx-auto py-12 border-t border-neutral-200 dark:border-neutral-800">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 text-sm text-neutral-500">
          <p>© 2026 Tim Kao</p>

          <div className="flex gap-6">
            <a
              href="mailto:你的email@example.com"
              className="hover:text-black dark:hover:text-white transition-colors"
            >
              Email
            </a>
            <a
              href="https://github.com/tim-kao"
              target="_blank"
